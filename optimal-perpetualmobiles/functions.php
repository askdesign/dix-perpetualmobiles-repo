...
define( 'CHILD_THEME_URL', 'https://my.studiopress.com/themes/optimal/' );

//* Enqueue Lato Google font
add_action( 'wp_enqueue_scripts', 'genesis_sample_google_fonts' );
function genesis_sample_google_fonts() {
	wp_enqueue_style( 'google-font', 'https://fonts.googleapis.com/css2?family=PT+Sans:ital,wght@0,400;0,700;1,400;1,700&family=Simonetta:ital,wght@0,400;0,900;1,400;1,900&display=swap', array(), PARENT_THEME_VERSION );
}
...
function custom_footer_creds_text() {
    ...
    echo 'Copyright &copy; ';
    echo date('Y');
 	echo ' &middot; Vladimir Barsukov &middot; <a href="https://appfinite.com/shop/optimal/">Optimal Theme</a> &middot; Built on the WordPress 
